...
void PeleLM::readProbParm()
{
   ...
   pp.query("flame_radius",  PeleLM::prob_parm->flame_radius);
   ...
   if (PeleLM::prob_parm->hitIC) {
      ...
      ppic.query("buffer_boundary",PeleLM::prob_parm->buffer_boundary);
      ppic.query("buffer_thickness",PeleLM::prob_parm->buffer_thickness);
      ...
      PeleLM::prob_parm->Linput = (xarray[nx - 1] + 0.5 * xdiff[nx - 1]) - (xarray[0] - 0.5 * xdiff[0]);
